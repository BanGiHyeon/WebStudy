...
// Connection 생성을 제한 => 연결 시간을 줄일 수 있다 
...
public class FoodDAO {
	...
	// 오라클 서버와 연결하는 Socket
	private PreparedStatement ps;// 송수신 역할 => SQL을 전송 결과값 받기 
	// OutpuStream / BufferedReader
	...
	public List<FoodVO> foodListData(int page)
	{
		...
		try
		{
			...
			while(rs.next())// 첫번째 ROW부터 읽어서 마지막까지 읽어오기 
			{
