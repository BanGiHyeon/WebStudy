...
<body>
   <div class="container"> <%-- container는 화면의 범위 --%>
      <div class="col-sm-7"> <%-- 12등분이 되어 있음. 그래서 7하고 5로 나눈것 --%> <%-- float:left --%>
         <table class="table">
            <tr>
      ...
      <div class="col-sm-5">
         ...
         <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=350f1ecf647b74ae9dc0cd1a0c449204&libraries=services"></script>
         <script>
